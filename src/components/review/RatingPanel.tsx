...
export function RatingPanel({ conversationId }: RatingPanelProps) {
  ...
  return (
    <div className="w-80 border-l border-border bg-card flex flex-col h-full overflow-hidden">
      <Tabs defaultValue="rating" className="flex-1 flex flex-col overflow-hidden">
        <TabsList className="grid w-full grid-cols-2 bg-muted/30 border-b border-border p-0 h-10 rounded-none">
          <TabsTrigger 
            value="rating" 
            className="rounded-none border-b-2 border-transparent data-[state=active]:border-brand-orange data-[state=active]:bg-transparent data-[state=active]:text-brand-orange text-[10px] uppercase font-mono tracking-widest transition-all"
          >
          ...
          <TabsTrigger 
            value="artifacts" 
            className="rounded-none border-b-2 border-transparent data-[state=active]:border-brand-pink data-[state=active]:bg-transparent data-[state=active]:text-brand-pink text-[10px] uppercase font-mono tracking-widest transition-all"
          >
        ...
        <TabsContent value="rating" className="flex-1 overflow-y-auto scrollbar-none p-6 space-y-8 m-0">
          <div>
          ...
          <div className="flex flex-col space-y-2">
            ...
            <textarea
              className="flex-1 min-h-[120px] w-full p-3 text-sm bg-muted/30 border border-border/50 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-orange/50 text-foreground placeholder:text-muted-foreground resize-none transition-all"
